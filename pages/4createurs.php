     ...
     <div class="row text-center">
       <div class="col-sm-6 col-md-3">
            ...
            <div style="position: relative; left: 0; top: 0;">
                <img class="photomaud" src="images/Maudnoir.png">
       ...
       <div class="col-sm-6 col-md-3">
         <div class="feature">
            ...
            <img src="images/demas.png" width="185">
            <p class="prenom" style="font-family: normal 400 16px/1.4 ">MARIE DE CAMAS</p>
            <p class="metierscrea" style="font-family: normal 400 16px/1.4 "><I>Co-fondatrice</p></I>
            <p class="texte" style="font-family: normal 400 16px/1.4 ">
       ...
       <div class="col-sm-6 col-md-3">
         ...
         <img class="photocadre2" src="images/cadre.png" width="292" height="400" style="position: absolute; top: 30px; left: 70px;"/>
           <img src="images/lui.png" width="200">
            <p class="prenom" style="font-family: normal 400 16px/1.4 ">GUILLAUME LAGANE</p>
            <p class="metierscrea" style="font-family: normal 400 16px/1.4 "><I>Illustrateur</p></I>
            <p class="texte" style="font-family: normal 400 16px/1.4 ">
       ...
       <div class="col-sm-6 col-md-3">
         ...
         <img class="photocadre3" src="images/cadre.png" width="273" height="400" style="position: absolute; top: 30px; left: 70px;"/>
           <img src="images/PhotoProfilDo.jpg" width="180" height="230">
            <p class="prenom" style="font-family: normal 400 16px/1.4 ">DOROTHEE CORBIER</p>
            <p class="metierscrea" style="font-family: normal 400 16px/1.4 "><I>Communication</p></I>
            <p class="texte" style="font-family: normal 400 16px/1.4 ">
